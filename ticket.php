                                ...
                                function fechar(){
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(response){
                                            ...
                                            if(response == "true"){
                                                window.location.href = "ticket.php?ref=" + ticketREF;
                                            }else{
                                                mensagemAlerta("Ocorreu um erro ao fechar o ticket.");  
                                            }
                                        }
...
<div class="display-ticket">
    ...
    <div class="ticket-content">
        <div class="message-field">
            ...
            <form class="ticket-message" method="post" action="ticket-send.php" enctype="multipart/form-data">
...
<?php
    ...
    echo "<div align=center><a href='create-ticket.php' class='link-padrao'>Voltar</a></div>";
}
?>